...
parser.add_argument('--name_id_mapper_path', default="/home/airlab/storage/airlab/data_0108/data/InsDet/OWID/P1/ZID-10k_mapper.json", help="Path to name id mapper")
...
parser.add_argument('--output_dir', default="/home/airlab/storage/airlab/OWID/P2_raw_2", help="Path to where the final files, will be saved")
parser.add_argument('--num_objects', type=list, default=[1, 2], help="How many objects are in a scene")
...
def load_shapnet_objs(shapenet_dataset_path: str, num_objs, name_id_mapper=None) -> List[MeshObject]:
    """ Loads all or a subset of 3D models of any BOP dataset
    :return: The list of loaded mesh objects.
    """
    mapper = name_id_mapper
    loaded_obj= []
...
def main(s, args):
    ...
    with open(args.name_id_mapper_path, 'r') as f:
        mapper = json.load(f)
    shapenet_objs = load_shapnet_objs(args.shapenet_path, num_objects, mapper)
